...
begin
  //reintroduce in descendent classes.
  //Add: MyClassType;
  //result := MyClassType.CreateNew;
  result := TBaseMapObject.CreateNew;
  Add(Result);
end;
...
function TMapUnitDefList.Add(const aUnitName: String): TMapUnitDef;
begin
  result := Add;
