...
uses
  Classes, SysUtils, tiObject, agtiPropertyGUI_Inc, agtiPropertyGUIManager;
...
begin
  ...
  if not(Assigned(aOutput)) or (aOutput = nil) then exit;
  ...
  wln('Uses');
  iTab;
  wln('Classes, SysUtils, tiObject, agtiPropertyGUI_Inc, agtiPropertyGUIManager;');
  wbr;
  dTab;
  wln('type');
  iTab;
